...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(
            id='statistics',
            options=list containing dictionaries,
    ...
    html.Div(id='output-container', className='chart-grid', style={displayed as a flex}),])
])
#TASK 2.4: Creating Callbacks
# Define the callback function to update the input container based on the selected statistics
@app.callback(
    Output(component_id='select-year', component_property='disabled'),
    Input(component_id='statistics',component_property='....'))
...
# Define the callback function to update the input container based on the selected statistics
@app.callback(
    Output(component_id='statistics', component_property='...'),
    [Input(component_id='select-year', component_property='Yearly Statistics'), Input(component_id='select-year', component_property='Recession Period Statistics')])
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        average_sales = recession_data.groupby('vehicle type')                 
        R_chart2  = dcc.Graph(
            figure=px.bar(.............,
            x='vehicle type ',
            y='Automobile_Sales ',
